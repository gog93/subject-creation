        ...
        C = function () {
            ...
            return t = e, o = [{
                ...
                key: "afterSetSearchValue", value: function () {
                    this.hasServerSearch ? this.serverSearch() : this.setVisibleOptionsCount(), this.selectAllOnlyVisible && this.toggleAllOptionsClass(), this.focusOption({focusFirst: !0})
                }
            }, {
                ...
                key: "setOptions", value: function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = [],
                        ...
                        h = this.secureText.bind(this), c = this.getAlias.bind(this), d = 0, f = !1, y = {}, b = !1;
                    this.disabledOptions.forEach((function (e) {
                        y[e] = !0
                    }));
                    var g = function e(s) {
                        "object" !== v(s) && (s = {value: s, label: s});
                        var g = h(u(s[o])), m = s.options, O = !!m, S = {
                            index: d,
                            value: g,
                            label: h(u(s[n])),
                            alias: c(s[a]),
                    ...
                    if (u && this.hideValueTooltipOnSelectAll) s.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(a, ")"); else {
                        ...
                        if ("" === c) s.innerHTML = this.placeholder; else if (s.innerHTML = c, e) {
                            ...
                            if (p.hasEllipsis(s) || d || this.alwaysShowSelectedOptionsCount || o) {
                                ...
                                if (d && (v += ' / <span class="vscomp-max-value-count">'.concat(d, "</span>")), u) s.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(a, ")"); else if (o) s.innerHTML = r.join(""), this.$valueTags = s.querySelectorAll(".vscomp-value-tag"), this.setValueTagAttr(); else {
                ...
                key: "selectOption", value: function (e) {
                    ...
                    if (e) {
                        ...
                        var n = this.selectedValues, r = p.getData(e, "value"), a = p.getData(e, "index", "number"),
                            l = !1, u = this.lastSelectedOptionIndex;
                        if (this.lastSelectedOptionIndex = null, this.toggleSelectedProp(a, o), o) {
                            if (this.multiple) n.push(r), this.toggleAllOptionsClass(), this.toggleGroupOptionsParent(e), i && i.shiftKey && (l = !0); else {
                        ...
                        p.hasClass(e, "current-new") && this.beforeSelectNewValue(), this.setValue(n), l && this.selectRangeOptions(u, a)
                    }
                }
            }, {
                ...
                key: "toggleAllOptions", value: function (e) {
                    if (this.multiple && !this.disableSelectAll) {
                        ...
                        var t = [], i = this.selectAllOnlyVisible;
                ...
                key: "validate", value: function () {
                    ...
                    var e = !1;
                    return this.required && s.isEmpty(this.selectedValues) && (e = !0), p.toggleClass(this.$allWrappers, "has-error", e), !e
                }
            }, {
        ...
        return (t = [{
            ...
            key: "setPosition", value: function () {
                ...
                var e, t, n, r = window.innerWidth, a = window.innerHeight, l = i.getAbsoluteCoords(this.$popperEle),
                    ...
                    S = u.left, x = g - c, w = S - f, k = w, C = x, E = this.position, A = this.secondaryPosition,
                ...
                var H = {
                    top: {top: C - h - D, left: k + $},
                    bottom: {top: C + b + D, left: k + $},
                    right: {top: C + T, left: k + y + D},
                    left: {top: C + T, left: k - p - D}
                }, W = H[E];
                if (C = W.top, k = W.left, A && ("top" === A ? C = x : "bottom" === A ? C = x + b - h : "left" === A ? k = w : "right" === A && (k = w + y - p)), k < M ? "left" === E ? n = "right" : k = M + f > m ? m - f : M : k + p > F && ("right" === E ? n = "left" : k = F + f < S ? S - d : F - p), C < P ? "top" === E ? n = "bottom" : C = P + c > O ? O - c : P : C + h > I && ("bottom" === E ? n = "top" : C = I + c < g ? g - v : I - h), n) {
                    var q = H[n];
                    "top" === (E = n) || "bottom" === E ? C = q.top : "left" !== E && "right" !== E || (k = q.left)
                }
                ...
                if (i.setStyle(this.$popperEle, "transform", j), i.setData(this.$popperEle, "fromLeft", t), i.setData(this.$popperEle, "fromTop", e), i.setData(this.$popperEle, "top", C), i.setData(this.$popperEle, "left", k), i.removeClass(this.$popperEle, o.join(" ")), i.addClass(this.$popperEle, "position-".concat(E)), this.hasArrow) {
                    var N = 0, L = 0, R = k + f, B = C + c, z = this.$arrowEle.offsetWidth / 2, K = s[E] || "";
                    "top" === E || "bottom" === E ? (N = y / 2 + S - R) < z ? N = z : N > p - z && (N = p - z) : "left" !== E && "right" !== E || ((L = b / 2 + g - B) < z ? L = z : L > h - z && (L = h - z)), i.setStyle(this.$arrowEle, "transform", "translate3d(".concat(N, "px, ").concat(L, "px, 0) ").concat(K))
                }
